...
def loadAllModels():
    ...
    global model_symbol
    global reader
    model = torch.hub.load('ultralytics/yolov5:v7.0', 'custom', path=r"C:\Users\Sanjay Yadav\Downloads\best (2).pt")
    print("YOLOv5 model loaded successfully!")
    # Set the model to inference mode
    model.eval()
    model_logo = load_model(r"C:\Users\Sanjay Yadav\Downloads\logo_classification_model (1).h5")
    model_symbol = load_model(r"C:\Users\Sanjay Yadav\Downloads\title_classification_model.h5")
...
def serve_image(filename):
    return send_from_directory(r'C:\Users\Sanjay Yadav\OneDrive\Desktop\BackendModels\images\cropped', filename)


@app.route('/upload', methods=['POST'])
def upload():
    clear_existing_images("C:/Users/Sanjay Yadav/OneDrive/Desktop/BackendModels/images/cropped")
    global model
    global model_logo
    global model_symbol
    try:
        ...
        pdf_image.save(Path(r'C:\Users\Sanjay Yadav\OneDrive\Desktop\BackendModels\images\cropped\uploaded.jpg'))
        ...
        for class_name, best_box in best_boxes.items():
            ...
            cropped_image.save(Path(f'C:\\Users\\Sanjay Yadav\\OneDrive\\Desktop\\BackendModels\\images\\cropped\\cropped_{class_name}.jpg'))
        ...
        number_path=r'C:\Users\Sanjay Yadav\OneDrive\Desktop\BackendModels\images\cropped\cropped_0.0.jpg'
        ...
        single_image_path = r"C:\Users\Sanjay Yadav\OneDrive\Desktop\BackendModels\images\cropped\cropped_2.0.jpg" 
        ...
        single_image_path = r"C:\Users\Sanjay Yadav\OneDrive\Desktop\BackendModels\images\cropped\cropped_3.0.jpg" 
        ...
        number_path=r'C:\Users\Sanjay Yadav\OneDrive\Desktop\BackendModels\images\cropped\cropped_1.0.jpg'
        if(os.path.exists(number_path)):
            with open(number_path,'rb') as number_file:
                content=number_file.read()
        ...
        number_path=r'C:\Users\Sanjay Yadav\OneDrive\Desktop\BackendModels\images\cropped\cropped_4.0.jpg'
        if(os.path.exists(number_path)):
            with open(number_path,'rb') as number_file:
                content=number_file.read()
